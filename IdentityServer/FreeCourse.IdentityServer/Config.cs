...
namespace FreeCourse.IdentityServer
{
        ...
        public static IEnumerable<ApiResource> ApiResources => new List<ApiResource>
    {
        ...
        {
            Scopes = { "payment_fullpermisssion" }
        },
        ...
        new ApiResource("resource_getway")
        {
            Scopes = { "getway_fullpermisssion" }
        },
        ...
        public static IEnumerable<IdentityResource> IdentityResources => new List<IdentityResource>
{
        ...
        public static IEnumerable<ApiScope> ApiScopes => new List<ApiScope>
    {
        ...
        new ApiScope("payment_fullpermisssion", "Payment API için erişim"),
        new ApiScope("getway_fullpermisssion", "Getway API için erişim"),
    };
        ...
        public static IEnumerable<Client> Clients => new List<Client>
    {
        new Client
        {
            ...
            AllowedScopes = { "catalog_fullpermisssion", "getway_fullpermisssion", "photo_stock_fullpermisssion", IdentityServerConstants.LocalApi.ScopeName }
        },
